...
int main()
{
	...
	char* vertexSourse = filetobuf("c:\temp\study_project\lab_04\vertexShaderSourse.qwerty");
	...
	// fragment shader
	char* fragmentSourse = filetobuf("c:\temp\study_project\lab_04\fragmentShaderSourse.qwerty");
