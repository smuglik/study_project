...
int main()
{
  ...
  Shader lampShader("vertexShaderSourse_light.txt", "fragmentShaderSourse_light.txt");
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for (int i = 0; i < 4; i++)
    {
      ...
      lightingShader.setFloat(buffer, 1.0);
    ...
    //  lightingShader.setVec3(buffer, vec3(0.0));

      sprintf(buffer, "pointLights[%i].specular", i);
      lightingShader.setVec3(buffer, vec3(1.0));
    }
   ...
   // lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
    ...
    lightingShader.setFloat("light.cutOff", cos(radians(12.5)));
    lightingShader.setFloat("light.outerCutOff", cos(radians(17.5)));
