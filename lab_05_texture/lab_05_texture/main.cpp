...
int main()
{
	...
	unsigned char *data = stbi_load("wood.jpg", &w1, &h1, &nrChannels, 0);
	...
	//shader compilation
	// vertex shader
	char* vertexSourse = filetobuf("C:\\temp\\smuglik\\vertexShaderSourse.txt.txt");
	...
	// fragment shader
	char* fragmentSourse = filetobuf("C:\\temp\\smuglik\\fragmentShaderSourse.txt.txt");
